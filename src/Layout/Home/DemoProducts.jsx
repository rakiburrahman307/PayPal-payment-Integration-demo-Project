      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
        {products?.slice(0, 3).map(product => (
          <Link to={`/details/${product?.id}`} key={product?.id}>
            <div className='w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 duration-500 ease-in-out transform hover:shadow-lg hover:scale-105'>
              <div
                style={{
