        ...
        <table className='min-w-[90%] shadow-md border mx-auto border-gray-100 my-6'>
          <thead>
            <tr className='bg-[#0095FF] text-white'>
              <th className='py-4 px-6 text-lg text-left border-b'>Payment Id</th>
          ...
          <tbody>
            <tr className='hover:bg-gray-50 border-b transition duration-300'>
              ...
              <td className='py-4 px-6 text-green-500 border-b text-lg font-medium'>{orderDetails?.orderData?.status}</td>
            </tr>
          </tbody>
        </table>
      </div>
